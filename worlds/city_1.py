...
class Stat_up:
    ...
    def ret_plus_but(self):
        return [[range(int(1105 * k), int(1135 * k)), range(int(300 * k), int(330 * k))], [range(int(1105 * k), int(1135 * k)), range(int(340 * k), int(370 * k))],
                [range(int(1105 * k), int(1135 * k)), range(int(380 * k), int(410 * k))], [range(int(1105 * k), int(1135 * k)), range(int(420 * k), int(450 * k))]]
...
class Magaz:
    ...
    def ret_plus_but(self):
        return [[range(int(825 * k - 65), int(875 * k)), range(int(310 * k - 65), int(360 * k))], [range(int(910 * k - 65), int(960 * k)), range(int(310 * k - 65), int(360 * k))],
                   [range(int(1000 * k - 65), int(1050 * k)), range(int(310 * k - 65), int(360 * k))], [range(int(1085 * k - 65), int(1135 * k)), range(int(310 * k - 65), int(360 * k))]]
            ...
            for i in range(len(self.list_house)):
                if str((col, row)) in str(self.list_house[i].ret_form()) and self.f:
                    ...
                    if self.list_house[i].ret_name() == 's1' or self.list_house[i].ret_name() == 'm1':
                        self.list_house[i].red_clic((int(1155 * k) - 65, int(560 * k) - 65))
                    else:
                    ...
                    if cell[0] in self.list_house[i].ret_range_viget_but()[0] \
                        ...
                        for j in range(len(self.list_house[i].ret_plus_but())):
                            if cell[0] in self.list_house[i].ret_plus_but()[j][0] \
                                ...
                                print(self.list_house[i].ret_stat_point())
